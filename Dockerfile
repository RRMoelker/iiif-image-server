...
CMD ["sh", "-c", "java -Dcantaloupe.config=/etc/cantaloupe/cantaloupe.properties -Dhttp.proxyHost=10.240.2.1 -Dhttp.proxyPort=8800 -Dhttps.proxyHost=10.240.2.1 -Dhttps.proxyPort=8800 -Xmx2g -jar /usr/local/cantaloupe/cantaloupe-4.1-SNAPSHOT.war"]
