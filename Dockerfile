...
RUN cd /tmp/cantaloupe-develop && mvn clean package -DskipTests -Dhttp.proxyHost=10.240.2.1 -Dhttp.proxyPort=8080 -Dhttps.proxyHost=10.240.2.1 -Dhttps.proxyPort=8080 -Dhttp.nonProxyHosts="localhost|127.0.0.1"
RUN cd /usr/local \
